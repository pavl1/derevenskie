    ...
    <div>
        ...
        <div class="row">
            <div class="description">
                <p>Запуск полноценной молочной фермы на 200 голов позволяет получать ежедневно 1500-2500 литров молока. Минизавод по переработке молока позволяет получать ежедневно молока 2,5% жирности 400 кг, кефира 2,5% жирности 250 кг, йогурта 2,5% жирности 200 кг, сметаны 20% жирности 100 кг, творога 9% жирности 150 кг, масла сливочного 82,5% жирности 25 кг. Годовая выручка от реализации продукции, половина которой уходит на покрытие текущих расходов, составит 20-22 млн рублей.</p>
            </div>
            <div class="question">
