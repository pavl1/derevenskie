        ...
        data() {
            return {
                ...
                data: {
                    ...
                    fuel: [
                        { id: 0, name: '85 тонн ДТ', selected: '85 тонн дизельного топлива' },
                        { id: 1, name: '125 тонн ДТ', selected: '125 тонн дизельного топлива' },
                        { id: 2, name: '200 тонн ДТ', selected: '200 тонн дизельного топлива' },
                        { id: 3, name: '400 тонн ДТ', selected: '400 тонн дизельного топлива' }
                    ]
                },
                result: {
                    money: [
                    ...
                    product: [
                        { id: 0, name: '600 тонн пшеницы' },
                        { id: 1, name: '900 тонн пшеницы' },
                        { id: 2, name: '1 500 тонн пшеницы' },
                        { id: 3, name: '3 000 тонн пшеницы' }
                    ],
                    area: [
